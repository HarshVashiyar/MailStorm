  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_BASE_URL}${import.meta.env.VITE_USER_SIGNIN_ROUTE}`,
        {
          email,
          password,
        },
  ...
  return (
    <div className="flex flex-col min-h-screen px-4 sm:px-6 lg:px-8">
      <div className="flex items-center justify-center flex-grow py-12">
        <div className="bg-dark-800/20 backdrop-blur-xl border border-white/10 rounded-2xl shadow-glass w-full max-w-md p-8 relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <h2 className="text-2xl font-bold mb-6 text-center bg-gradient-to-r from-primary-400 to-accent-400 bg-clip-text text-transparent">Sign In</h2>
